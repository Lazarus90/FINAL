...
$correcto = false;
$archivo = "users.txt";
$hand = fopen($archivo,"r") or die("No se ha encontrado el archivo."); // Abrimos el archivo modo lectura
...
if($correcto==true){
    ...
    //echo("<script>location.href = 'index.php".ADMIN_URL."/index.php?msg=$msg';</script>");
}else{
        ...
        <div class="navbar">            
            <div class="navbar-inner">                
                <div class="container">                    
                  ...
                  <!-- End main navigation -->
                  <div class="w3-display-topright">Bienvenidodo [usuario]</div>
...
<div id="ingresar">    
        <div class="section primary-section">            
                <div class="triangle"></div>                
                    <center>
                    <h2 style="color:#EEEE6E">Ingresar</h2>
                    <center>  
                    <p>Registre con nosotros y podrás realizar apartados de cualquiera de nuestros productos.</p>
...
<div class="module form-module">
  ...
  <div class="form">
    <h2>Ingresa tu usuario y contraseña</h2>
     <form name="login" name="login" method="POST" action="index.php">
      <input type="text" id="nombreUsuario" placeholder="Nombre de usuario" name="txtUsuario" required/>
  ...
  <div class="form">
    ...
    <form>
        ...
        <input type="text" id="nombre" placeholder="Nombre de Usuario"  title="Tu nombre" required/>
        <label for="contraseña">Contraseña</label>
        <input type="password" id="contraseña" placeholder="Contraseña"  title="Tu contraseña" required/>
        <label for="email">Email</label>
        <input type="email" id="email" placeholder="Dirección de e-mail"  title="Tu email" required/>
        <label for="telefono">Telefono</label>
        <input type="number" id="telefono"placeholder="Número de tel."  title="Tu n{umero de tel"required/>    
        <label for="fecha_nac">Fecha de nacimiento</label>
        <input type="date" id="fecha_nac" class="cambio" name="nacimiento_txt" title="Tu cumpleaños" required>
        <label>Sexo </label>        <hr>
        ...
        <button onclick="validarN()">Registrar</button>        
    </form>
    <?php validar();?>
  </div>
  <div class="cta"><a href="#">¿Olvidaste tu contraseña?</a></div>
        ...
        </div> <!-- fin seccioón negra http://andytran.me -->    
</div>         
